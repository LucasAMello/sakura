...
The release executable remains unavailable for direct visual comparison. Portals are omitted between ordinary maps, the first-stage reward continues directly to map20, and the second-stage reward continues directly to map30 after its portal departure. The half-rate World 2 pacing is confirmed playtest tuning and takes precedence over the archive's raw tick speed. Music, sound effects, menus, saving, and weapon-selection systems remain project-wide omissions rather than missing stage-two gameplay entities.
